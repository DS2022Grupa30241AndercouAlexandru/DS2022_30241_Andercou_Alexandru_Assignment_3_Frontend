...
headers:any
  ...
  constructor(private httpc: HttpClient, private router: Router,private ls:LocatorService,private chat:ChatComponentComponent) {
...
makeChat()
{
  ...
  var componentRef = viewContainerRef.createComponent<ChatComponentComponent>(ChatComponentComponent)
   componentRef.instance.set_user(this.numberChats,this.admin,this.user_search,"admin")
  ...
  ngOnInit() {
    ...
    if (ua == "ADMIN") {
      ...
      if (well && well instanceof HTMLHeadingElement) {
        ...
        this.httpc.get(this.url12 + "/" + id,{headers:this.headers}).subscribe(data => {
          var d: any = data;
        ...
        for(let bt=0;bt< but.length;bt++)
     {
      ...
      this.httpc.get(this.url6, { headers: this.headers }).subscribe(data => {
      ...
      this.httpc.get(this.url4,{ headers: this.headers }).subscribe(data => {
        setTimeout(() => {
      ...
      this.httpc.get(this.url5,{ headers: this.headers }).subscribe(data => {
      ...
      var srv=new GrpcService();
      srv.wait_for_notification(0,this.update_notification.bind(this));
  ...
  addUser(userForm: any) {
    ...
    this.httpc.post(this.url1, user,{ headers: this.headers }).subscribe(response=>{
  ...
  addDevice(deviceForm: any) {
    ...
    this.httpc.post(this.url2, device,{ headers: this.headers }).subscribe(response=>{
  ...
  addMapping(mapForm: any) {
    ...
    this.httpc.post(this.url3, deviceuser,{ headers: this.headers }).subscribe(response=>{
  ...
  addMeasure(measureForm: any) {
    ...
    this.httpc.post(this.url7, body,{ headers: this.headers }).subscribe(response=>{
  ...
  var bt1=document.getElementById("deleteU")
  var bt2=document.getElementById("updateU")
  var bt3=document.getElementById("makeChat")
  if(bt1 && bt1 instanceof HTMLElement)
  ...
  this.user_search.role.type=inp3.value
   ...
   this.httpc.post(this.url10, this.user_search,{ headers: this.headers }).subscribe(response=>{
...
this.httpc.post(this.url11, this.device_search,{ headers: this.headers }).subscribe(response=>{
  ...
  deleteUser() {
    ...
    this.httpc.post(this.url8, data_to_send, { headers: this.headers }).subscribe(response=>{
  ...
  deleteDevice() {
    ...
    this.httpc.post(this.url9, data_to_send, { headers: this.headers }).subscribe(response=>{
  ...
  "dev":this.map_search.deviceId
    ...
    this.httpc.post(this.url15, data_to_send, { headers: this.headers }).subscribe(response=>{
  ...
  searchUserById(id: number) {
    this.httpc.get(this.url12 + "/" + id,{ headers: this.headers }).subscribe(response => {
 ...
 update_notification(notifications:any)
{

  var notif_div= document.getElementById("requests")
  if(notif_div)
{
  notif_div.innerHTML=""
...
var new_p=document.createElement("p")
  new_p.textContent=n.messagetosend
  notif_div.appendChild(new_p)
